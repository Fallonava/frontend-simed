# 🔄 Safe Database Migration Guide (Production)

## ⚠️ CRITICAL: Never Use These Commands on Production
...
# 🔥 SAFE COMMAND - Only applies pending migrations
npx prisma migrate deploy

# This will:
# ✅ Apply new migrations WITHOUT resetting database
# ✅ Keep all existing data intact
# ✅ Only add new tables/columns as defined in migrations
```
...
## 📊 Current Schema Changes Pending
...
- [ ] ✅ Verify migration SQL doesn't have `DROP TABLE` or `DROP COLUMN`
- [ ] ✅ Check that migration is **additive only** (adds tables/columns, doesn't remove)
- [ ] ✅ Ensure database user has **ALTER TABLE** permissions
- [ ] ✅ Schedule migration during **low-traffic hours** (if possible)
...
## 📝 Full Migration Execution (Copy-Paste Ready)
