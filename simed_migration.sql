...
\restrict PsQHuJctYqgWuSiqrxwMxmZFtM2Psw3wTiJB0YqsdoL2dpn5bOhcnzv1DAGBJvm
...
ALTER TABLE IF EXISTS ONLY public."Transaction" DROP CONSTRAINT IF EXISTS "Transaction_patient_id_fkey";
ALTER TABLE IF EXISTS ONLY public."Transaction" DROP CONSTRAINT IF EXISTS "Transaction_medical_record_id_fkey";
ALTER TABLE IF EXISTS ONLY public."TransactionItem" DROP CONSTRAINT IF EXISTS "TransactionItem_transaction_id_fkey";
ALTER TABLE IF EXISTS ONLY public."Queue" DROP CONSTRAINT IF EXISTS "Queue_patient_id_fkey";
ALTER TABLE IF EXISTS ONLY public."Queue" DROP CONSTRAINT IF EXISTS "Queue_daily_quota_id_fkey";
ALTER TABLE IF EXISTS ONLY public."Prescription" DROP CONSTRAINT IF EXISTS "Prescription_patient_id_fkey";
ALTER TABLE IF EXISTS ONLY public."Prescription" DROP CONSTRAINT IF EXISTS "Prescription_medical_record_id_fkey";
ALTER TABLE IF EXISTS ONLY public."Prescription" DROP CONSTRAINT IF EXISTS "Prescription_doctor_id_fkey";
ALTER TABLE IF EXISTS ONLY public."PrescriptionItem" DROP CONSTRAINT IF EXISTS "PrescriptionItem_prescription_id_fkey";
ALTER TABLE IF EXISTS ONLY public."PrescriptionItem" DROP CONSTRAINT IF EXISTS "PrescriptionItem_medicine_id_fkey";
ALTER TABLE IF EXISTS ONLY public."MedicalRecord" DROP CONSTRAINT IF EXISTS "MedicalRecord_queue_id_fkey";
ALTER TABLE IF EXISTS ONLY public."MedicalRecord" DROP CONSTRAINT IF EXISTS "MedicalRecord_patient_id_fkey";
ALTER TABLE IF EXISTS ONLY public."MedicalRecord" DROP CONSTRAINT IF EXISTS "MedicalRecord_doctor_id_fkey";
ALTER TABLE IF EXISTS ONLY public."Doctor" DROP CONSTRAINT IF EXISTS "Doctor_poliklinik_id_fkey";
ALTER TABLE IF EXISTS ONLY public."DoctorSchedule" DROP CONSTRAINT IF EXISTS "DoctorSchedule_doctor_id_fkey";
ALTER TABLE IF EXISTS ONLY public."DoctorLeave" DROP CONSTRAINT IF EXISTS "DoctorLeave_doctor_id_fkey";
ALTER TABLE IF EXISTS ONLY public."DailyQuota" DROP CONSTRAINT IF EXISTS "DailyQuota_doctor_id_fkey";
DROP INDEX IF EXISTS public."User_username_key";
DROP INDEX IF EXISTS public."Transaction_medical_record_id_key";
DROP INDEX IF EXISTS public."Transaction_invoice_no_key";
DROP INDEX IF EXISTS public."Setting_key_key";
DROP INDEX IF EXISTS public."Sequence_key_key";
DROP INDEX IF EXISTS public."Poliklinik_queue_code_key";
DROP INDEX IF EXISTS public."Patient_no_rm_key";
DROP INDEX IF EXISTS public."Patient_nik_key";
DROP INDEX IF EXISTS public."Medicine_code_key";
DROP INDEX IF EXISTS public."DoctorLeave_doctor_id_date_key";
DROP INDEX IF EXISTS public."DailyQuota_doctor_id_date_key";
DROP INDEX IF EXISTS public."Counter_name_key";
...
ALTER TABLE IF EXISTS ONLY public."TransactionItem" DROP CONSTRAINT IF EXISTS "TransactionItem_pkey";
ALTER TABLE IF EXISTS ONLY public."Setting" DROP CONSTRAINT IF EXISTS "Setting_pkey";
ALTER TABLE IF EXISTS ONLY public."Sequence" DROP CONSTRAINT IF EXISTS "Sequence_pkey";
...
ALTER TABLE IF EXISTS ONLY public."Poliklinik" DROP CONSTRAINT IF EXISTS "Poliklinik_pkey";
ALTER TABLE IF EXISTS ONLY public."Playlist" DROP CONSTRAINT IF EXISTS "Playlist_pkey";
...
ALTER TABLE IF EXISTS ONLY public."DoctorLeave" DROP CONSTRAINT IF EXISTS "DoctorLeave_pkey";
ALTER TABLE IF EXISTS ONLY public."DailyQuota" DROP CONSTRAINT IF EXISTS "DailyQuota_pkey";
ALTER TABLE IF EXISTS ONLY public."Counter" DROP CONSTRAINT IF EXISTS "Counter_pkey";
ALTER TABLE IF EXISTS public."User" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."TransactionItem" ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public."Sequence" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."Queue" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."PrescriptionItem" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."Prescription" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."Poliklinik" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."Playlist" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."Patient" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."Medicine" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."MedicalRecord" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."DoctorSchedule" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."DoctorLeave" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."Doctor" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."DailyQuota" ALTER COLUMN id DROP DEFAULT;
...
DROP SEQUENCE IF EXISTS public."TransactionItem_id_seq";
DROP TABLE IF EXISTS public."TransactionItem";
DROP TABLE IF EXISTS public."Transaction";
DROP SEQUENCE IF EXISTS public."Setting_id_seq";
DROP TABLE IF EXISTS public."Setting";
DROP SEQUENCE IF EXISTS public."Sequence_id_seq";
...
DROP SEQUENCE IF EXISTS public."PrescriptionItem_id_seq";
DROP TABLE IF EXISTS public."PrescriptionItem";
DROP TABLE IF EXISTS public."Prescription";
DROP SEQUENCE IF EXISTS public."Poliklinik_id_seq";
DROP TABLE IF EXISTS public."Poliklinik";
DROP SEQUENCE IF EXISTS public."Playlist_id_seq";
DROP TABLE IF EXISTS public."Playlist";
DROP SEQUENCE IF EXISTS public."Patient_id_seq";
DROP TABLE IF EXISTS public."Patient";
DROP SEQUENCE IF EXISTS public."Medicine_id_seq";
DROP TABLE IF EXISTS public."Medicine";
DROP SEQUENCE IF EXISTS public."MedicalRecord_id_seq";
DROP TABLE IF EXISTS public."MedicalRecord";
DROP SEQUENCE IF EXISTS public."Doctor_id_seq";
DROP SEQUENCE IF EXISTS public."DoctorSchedule_id_seq";
DROP TABLE IF EXISTS public."DoctorSchedule";
DROP SEQUENCE IF EXISTS public."DoctorLeave_id_seq";
DROP TABLE IF EXISTS public."DoctorLeave";
DROP TABLE IF EXISTS public."Doctor";
DROP SEQUENCE IF EXISTS public."DailyQuota_id_seq";
DROP TABLE IF EXISTS public."DailyQuota";
...
31	10	2025-12-10 17:00:00	30	0	OPEN
32	11	2025-12-10 17:00:00	30	0	OPEN
34	14	2025-12-10 17:00:00	30	0	OPEN
...
33	12	2025-12-10 17:00:00	30	1	OPEN
35	15	2025-12-10 17:00:00	30	2	OPEN
28	5	2025-12-10 17:00:00	30	3	OPEN
29	6	2025-12-10 17:00:00	30	1	OPEN
30	7	2025-12-10 17:00:00	30	1	OPEN
...
SELECT pg_catalog.setval('public."Counter_id_seq"', 1, false);
...
SELECT pg_catalog.setval('public."DailyQuota_id_seq"', 47, true);
...
SELECT pg_catalog.setval('public."Queue_id_seq"', 36, true);
...
\unrestrict PsQHuJctYqgWuSiqrxwMxmZFtM2Psw3wTiJB0YqsdoL2dpn5bOhcnzv1DAGBJvm
