...
const Login = () => {
    ...
    return (
        <div className="min-h-screen bg-[#F5F5F7] flex items-center justify-center p-4 font-sans">
            <div className="bg-white rounded-3xl shadow-2xl p-8 w-full max-w-md border border-white/20 backdrop-blur-xl">
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-500 mt-2 text-sm">Sign in to access the queue system</p>
                </div>
                    ...
                    <div>
                        ...
                        <div className="relative group">
                            ...
                            <input
                                type="text"
                                required
                                className="w-full bg-gray-50 border border-gray-200 rounded-xl pl-12 pr-4 py-3.5 focus:ring-2 focus:ring-salm-purple/20 focus:border-salm-purple outline-none transition-all font-medium text-gray-800 placeholder-gray-400"
                    ...
                    <div>
                        ...
                        <div className="relative group">
                            ...
                            <input
                                ...
                                required
                                className="w-full bg-gray-50 border border-gray-200 rounded-xl pl-12 pr-12 py-3.5 focus:ring-2 focus:ring-salm-purple/20 focus:border-salm-purple outline-none transition-all font-medium text-gray-800 placeholder-gray-400"
                ...
                <div className="mt-8 pt-8 border-t border-gray-100 grid grid-cols-2 gap-4">
                    <button
                        ...
                        className="p-3 rounded-xl border border-gray-200 text-gray-600 hover:bg-gray-50 hover:border-gray-300 transition-colors text-sm font-medium flex flex-col items-center gap-1 group"
                    >
