    ...
    return (
        <div className="p-6 h-screen flex flex-col bg-slate-50 overflow-hidden">
            ...
            <header className="mb-6 flex justify-between items-center">
                ...
                <div className="flex gap-2">
                    <button
                        ...
                        className={`px-4 py-2 rounded-xl font-medium transition-all ${activeTab === 'unbilled' ? 'bg-emerald-500 text-white shadow-lg shadow-emerald-200' : 'bg-white text-slate-600 hover:bg-slate-100'}`}
                    >
                        Unbilled (Queue)
                    </button>
                    <button
                        onClick={() => setActiveTab('unpaid')}
                        className={`px-4 py-2 rounded-xl font-medium transition-all ${activeTab === 'unpaid' ? 'bg-blue-500 text-white shadow-lg shadow-blue-200' : 'bg-white text-slate-600 hover:bg-slate-100'}`}
                    >
                        Unpaid (Invoice)
                    </button>
                </div>
            ...
            <div className="flex-1 flex gap-6 overflow-hidden">
                {/* List Panel */}
                <div className="w-1/3 bg-white rounded-3xl shadow-xl shadow-slate-200/50 flex flex-col overflow-hidden border border-slate-100">
                ...
                {/* Detail/Action Panel */}
                <div className="flex-1 bg-white rounded-3xl shadow-xl shadow-slate-200/50 flex flex-col border border-slate-100 relative overflow-hidden">
                    {selectedItem ? (
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="flex justify-center mt-8">
                                            <button
                                                ...
                                                className="bg-emerald-500 hover:bg-emerald-600 text-white px-8 py-3 rounded-xl font-bold text-lg shadow-lg shadow-emerald-200 transition-all transform active:scale-95 flex items-center gap-2"
                                            >
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="border rounded-2xl overflow-hidden">
                                            <table className="w-full text-left text-sm">
                                                ...
                                                <tfoot className="bg-slate-50 font-bold">
                                                    <tr>
                                                        <td colSpan="2" className="p-4 text-right text-slate-600">Total</td>
                                                        <td className="p-4 text-right text-emerald-600 text-lg">
                                                            Rp {selectedItem.total_amount?.toLocaleString('id-ID')}
                                                        </td>
                                                    </tr>
                                                </tfoot>
                                        ...
                                        <div className="grid grid-cols-2 gap-4 mt-8">
                                            <button
                                                ...
                                                disabled={processing}
                                                className="h-20 bg-green-500 hover:bg-green-600 text-white rounded-2xl font-bold text-lg shadow-lg shadow-green-200 flex flex-col items-center justify-center gap-1 transition-all active:scale-95"
                                            >
                                            ...
                                            <button
                                                ...
                                                disabled={processing}
                                                className="h-20 bg-blue-500 hover:bg-blue-600 text-white rounded-2xl font-bold text-lg shadow-lg shadow-blue-200 flex flex-col items-center justify-center gap-1 transition-all active:scale-95"
                                            >
