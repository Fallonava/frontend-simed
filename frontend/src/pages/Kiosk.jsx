...
const Kiosk = () => {
    ...
    return (
        <div className="h-screen bg-theme-bg font-sans text-theme-text selection:bg-blue-500/20 flex flex-col overflow-hidden transition-colors duration-300">
            {/* Top Status Bar */}
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl border-b border-black/5 dark:border-white/5 shrink-0 z-50">
                <div className="max-w-[1920px] mx-auto px-6 h-16 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-6">
                        <div className="flex items-center gap-2 bg-gray-100/50 dark:bg-gray-700/50 px-3 py-1.5 rounded-full border border-black/5 dark:border-white/5">
                        ...
                        <div className="text-right">
                            <p className="text-xl font-bold tabular-nums tracking-tight leading-none text-gray-900 dark:text-white">
            ...
            <main className="flex-1 max-w-[1920px] w-full mx-auto p-6 flex flex-col min-h-0">
                <div className="mb-4 shrink-0">
                    <h2 className="text-2xl font-bold tracking-tight mb-1 text-gray-900 dark:text-white">Pilih Dokter Spesialis</h2>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Silakan pilih dokter yang tersedia untuk mengambil nomor antrian.</p>
                </div>
                        ...
                        {doctors.filter((doctor) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`
                                        group relative flex flex-col rounded-[1.5rem] p-4 text-left transition-all duration-300 border
                                        ${isAvailable
                                            ? 'bg-white dark:bg-gray-800 shadow-sm hover:shadow-xl hover:scale-[1.02] border-transparent hover:border-salm-blue/20'
                                            : 'bg-gray-100 dark:bg-gray-900/50 cursor-not-allowed grayscale-[0.8] opacity-80 border-transparent'}
                                    `}
                                >
                                    {/* Status Badge */}
                                    <div className="absolute top-3 right-3 z-10 text-[10px]">
                                        <div className={`
                                            ...
                                            ${status === 'OPEN' ? 'bg-green-100/80 text-green-700 border-green-200 dark:bg-green-900/30 dark:text-green-300 dark:border-green-800' :
                                                status === 'FULL' ? 'bg-orange-100/80 text-orange-700 border-orange-200 dark:bg-orange-900/30 dark:text-orange-300 dark:border-orange-800' :
                                    ...
                                    <div className="flex-1 flex flex-col items-center text-center pt-4">
                                        <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100 mb-1 leading-tight px-1 line-clamp-2 min-h-[3rem] items-center flex justify-center">{doctor.name}</h3>
                                    ...
                                    <div className="mt-2 pt-2 border-t border-gray-100 dark:border-gray-700 w-full">
                                        <div className="flex items-center justify-between mb-3">
                                            <div className="flex flex-col overflow-hidden text-left">
                                                <span className="text-[10px] text-gray-500 dark:text-gray-400 font-bold uppercase tracking-wider mb-px">Jam Praktek</span>
                                                <span className="font-bold text-base text-gray-800 dark:text-gray-200 truncate max-w-[100px]">
                                            ...
                                            <div className="text-right flex flex-col shrink-0">
                                                ...
                                                <span className="font-bold text-xl tabular-nums text-gray-900 dark:text-gray-100 leading-none">
                                        ...
                                        {isAvailable ? (
                                            ...
                                            <div className="w-full bg-gray-200 dark:bg-gray-700 text-gray-400 dark:text-gray-500 py-2 rounded-xl font-semibold flex items-center justify-center cursor-not-allowed text-xs">
