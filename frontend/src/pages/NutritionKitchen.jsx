        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-6 font-sans text-gray-900 dark:text-white pb-32">
            ...
            <header className="mb-8 flex justify-between items-center">
                <div>
                    ...
                    <p className="text-gray-500">Live Production & Tray Line</p>
                </div>
                <div className="text-right">
                    <div className="text-2xl font-bold font-mono">{new Date().toLocaleTimeString()}</div>
                    <div className="text-sm text-gray-400 font-bold uppercase tracking-wider">{orders.length} Active Orders</div>
                </div>
            </header>
                            ...
                            >
                                <div>
                                    ...
                                    <div className="mt-4 flex items-center gap-4 text-sm text-gray-500">
                                        <span className="flex items-center gap-1 font-bold"><UserIcon name={order.admission.patient.name} /></span>
                                        <span>•</span>
